...
// EXTERNAL MODULE: external "react-s-alert"
var external_react_s_alert_ = __webpack_require__("QKyr");
var external_react_s_alert_default = /*#__PURE__*/__webpack_require__.n(external_react_s_alert_);
...
// CONCATENATED MODULE: ./redux/types.tsx
const SET_DATA = "SET_DATA";
const FETCH_TASK = "FETCH_TASK";
const FETCH_TODO_LIST = "FETCH_TODO_LIST";
const FETCH_COMPLETED_LIST = "FETCH_COMPLETED_LIST";
// CONCATENATED MODULE: ./redux/reducer/todoListReducer.tsx
...
const todoList = (state = initialList, action) => {
  switch (action.type) {
    case SET_DATA:
...
// CONCATENATED MODULE: ./redux/reducer/fetchTaskReducer.tsx
...
// CONCATENATED MODULE: ./redux/reducer/index.tsx
...
// EXTERNAL MODULE: ./helpers/props.tsx
var props = __webpack_require__("rjsw");

// CONCATENATED MODULE: ./api/index.tsx
...
class api_api {
  constructor(obj) {
    api_defineProperty(this, "getState", void 0);

    api_defineProperty(this, "dispatch", void 0);

    api_defineProperty(this, "db", void 0);

    api_defineProperty(this, "Setter", data => {
      localStorage.setItem("todo-list", JSON.stringify(data));
      this.GetAll(this.getState().todoList.type, data);
    });

    api_defineProperty(this, "GetAll", (type = "All", data = this.db) => {
      switch (type) {
        case "All":
          this.dispatch({
            type: SET_DATA,
    ...
    api_defineProperty(this, "Get", id => {
      this.dispatch({
        type: FETCH_TASK,
    ...
    api_defineProperty(this, "Put", (id, data) => {
      let mirrorDb = [...this.db];
      const item = mirrorDb.filter(task => task.id === id)[0];
      if (!item) return;
      const indexOfItem = mirrorDb.indexOf(item);
      mirrorDb[indexOfItem] = api_objectSpread({}, item, {}, data);
      this.Setter(mirrorDb);
    });

    api_defineProperty(this, "Post", data => this.Setter([...this.db, api_objectSpread({}, data, {
      read: false,
      id: Object(props["b" /* uniq_id */])()
    })]));

    api_defineProperty(this, "Delete", id => this.Setter(this.db.filter(item => item.id !== id)));
...
const makeStore = initialState => {
  ...
  const store = Object(external_redux_["createStore"])(persistedReducer, initialState, composeEnhancers(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a.withExtraArgument({
    Api: api_api
  }))));
...
// CONCATENATED MODULE: ./public/styles/reset.tsx
/* harmony default export */ var styles_reset = (`
  body {
    margin: 0;
    padding: 0;
    direction: ltr;
...
`);
// CONCATENATED MODULE: ./public/styles/grid.tsx
...
`);
// EXTERNAL MODULE: ./public/styles/IRANSans/Farsi_numerals/webFonts/css/style.css
var style = __webpack_require__("XQP4");

// EXTERNAL MODULE: ./public/styles/IRANSans/WebFonts/css/style.css
var css_style = __webpack_require__("1Z3A");

// EXTERNAL MODULE: ./public/fonts/line/css/line-awesome.min.css
var line_awesome_min = __webpack_require__("Yl6M");

// EXTERNAL MODULE: ./public/fonts/fontello-97f03f85/css/mizkhabar.css
var mizkhabar = __webpack_require__("WhCv");
...
// EXTERNAL MODULE: ./node_modules/react-s-alert/dist/s-alert-default.css
var s_alert_default = __webpack_require__("JkUq");

// EXTERNAL MODULE: ./node_modules/react-s-alert/dist/s-alert-css-effects/jelly.css
var jelly = __webpack_require__("jRnG");
...
class _app_MyApp extends app_default.a {
  static async getInitialProps({
    ...
    if (Component.getInitialProps) {
      pageProps = await Component.getInitialProps(_app_objectSpread({}, ctx));
    }
  ...
  render() {
    ...
    return __jsx(external_react_["Fragment"], null, __jsx(external_react_redux_["Provider"], {
      store: store
    }, __jsx(external_styled_components_["ThemeProvider"], {
      theme: theme
    }, __jsx(Component, pageProps), __jsx(external_react_s_alert_default.a, {
      stack: {
        limit: 3
      }
...
"use strict";
/* unused harmony export toPersian */
/* unused harmony export moneyFormat */
/* unused harmony export underLine */
/* unused harmony export toEnglish */
/* unused harmony export remove */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return trunc; });
/* unused harmony export setIfNumber */
/* unused harmony export setCookie */
/* unused harmony export getCookie */
/* unused harmony export checkProtected */
/* unused harmony export daysRemaining */
/* unused harmony export checkPremiumDate */
/* unused harmony export daysLeft */
/* unused harmony export deleteCookie */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return uniq_id; });
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("4Q3z");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var jalali_moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("wfCd");
